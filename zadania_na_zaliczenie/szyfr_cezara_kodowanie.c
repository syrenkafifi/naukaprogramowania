...
int main(void){
    ...
    for(i=0; i<ilosc_znakow; i++){
		...
		if((65<=znak)&&(znak<=90)){
			...
			// moze zdarzyc sie sytuacja ze po przesunieciu wyjdziemy po za zakres (np znak= Z czyli 90 a przesuniecie bylo 1 i mamy znak_po_przesunieciu=91 co rowna sie klamerka i tu mozesz skonczyc)
